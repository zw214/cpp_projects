...
// the deskewing can be achieved by using image moments. A measure of 
// skewness is defined by the ratio of two central moments
...
// Here, we will convert the grayscale image to a feature vector using the HOG feature descriptor
...
int main() {
  ...
  ///// SVM Testing  ////////
  svmTest(model, testResponse, testMat);
